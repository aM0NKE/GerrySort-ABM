...
# Define parameters
state = 'GA'
runs = 1       # Number of runs per parameter set 
...
# Workers
    ...
    def gerrysort_model(state, job_id, params, control, data, output_dir):
        """
    ...
    while True:
        ...
        for job in jobs:
            ...
            gerrysort_model(state, job_id, params, control, data, output_dir)
