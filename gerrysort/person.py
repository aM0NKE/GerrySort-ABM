...
class PersonAgent(mg.GeoAgent):
    ...
    def is_unhappy(self):
        ...
        temp = self.model.temperature * rand_val # move this to moving options as noise term
        
        # NOTE: Temp can become negative due to random normal distribution, is this a problem?
        print(self.utility, temp, self.utility < temp)
        return self.utility < temp
