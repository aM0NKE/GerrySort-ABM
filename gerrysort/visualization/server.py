...
model_params = {
    "print_output": mesa.visualization.Checkbox("Print Console Output", True),
    "save_plans": mesa.visualization.Checkbox("Save Plans", False), # Turn off when hosting for reviewers
    "vis_agents": mesa.visualization.Checkbox("Visualize Agents", True),
    ...
    "epsilon": mesa.visualization.Slider("Epsilon (Max. Population Deviation)", 0.01, 0.01, 1.00, 0.01),
